...
class Station {
    ...
    static compare(station, other) {
        if (station.open && !other.open) {
            return -1;
        } else if (other.open && !station.open) {
            return 1;
        }

        if (!station.open_slopes && other.open_slopes) {
            return 1;
        } else if (!other.open_slopes && station.open_slopes) {
            return -1;
        } else if (!station.open_slopes && !other.open_slopes) {
            return 0;
        }
        ...
        if (station.snow_slopes > other.snow_slopes) {
            return -1;
        }
        return 0;
    }
